...
export const productTypeBadge: Record<string, { label: string; cls: string }> = {
  PHYSICAL: { label: 'Physical', cls: 'bg-red-50 dark:bg-red-950/50 text-red-700 dark:text-red-300 border-red-200 dark:border-red-800' },
  DIGITAL: { label: 'Digital', cls: 'bg-rose-50 dark:bg-rose-950/50 text-rose-700 dark:text-rose-300 border-rose-200 dark:border-rose-800' },
