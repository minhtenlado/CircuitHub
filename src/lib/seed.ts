...
export async function seedDatabase() {
  ...
  if (existingCount > 0) {
    return { skipped: true, message: 'Database already initialized' };
  }

  console.log('🌱 Initializing CircuitHub production catalog...');
  ...
  const products: ProductInput[] = [
    ...
    // === DIGITAL: KiCad ===
    {
      ...
      category: catOpenSource.id, shop: shopB.id, seller: sellerB.id,
      unlimited: true,
      isFeatured: true, isTrending: true,
      software: 'KiCad', softwareVersion: 'KiCad 9', currentVersion: 'v2.1.0',
      fileFormat: '.kicad_pro,.kicad_pcb,.kicad_sch,.zip',
      fileSizeBytes: 28 * 1024 * 1024, licenseType: 'OPEN_SOURCE',
    ...
    },
    {
      ...
      fileFormat: '.kicad_pro,.kicad_pcb,.kicad_sch,.zip',
      fileSizeBytes: 14 * 1024 * 1024, licenseType: 'OPEN_SOURCE',
    ...
    },
    {
      ...
      fileFormat: '.kicad_pro,.kicad_pcb,.kicad_sch,.zip',
      fileSizeBytes: 9 * 1024 * 1024, licenseType: 'OPEN_SOURCE',
    ...
    // === DIGITAL: Altium ===
    {
      ...
      fileSizeBytes: 56 * 1024 * 1024, licenseType: 'OPEN_SOURCE',
    ...
    // === DIGITAL: Gerber ===
    {
      ...
      fileSizeBytes: 3 * 1024 * 1024, licenseType: 'OPEN_SOURCE',
    ...
    // === DIGITAL: Firmware ===
    {
      ...
      fileFormat: '.c,.h,.zip',
      fileSizeBytes: 8 * 1024 * 1024, licenseType: 'OPEN_SOURCE',
