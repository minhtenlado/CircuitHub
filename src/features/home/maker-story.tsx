...
export function MakerStory() {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 border-b border-border/50 bg-gradient-to-b from-transparent via-red-500/[0.02] to-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          
          {/* Left column: Authentic Maker Story */}
          <div className="lg:col-span-7 space-y-5">
            <div className="inline-flex items-center gap-2 rounded-full border border-red-500/30 bg-red-600/10 px-3 py-1 text-xs font-semibold text-red-700 dark:text-red-300">
            ...
            <div className="pt-3 flex flex-wrap items-center gap-3">
              <Button
                onClick={() => goProducts()}
                className="h-10 px-5 rounded-xl bg-red-600 hover:bg-red-700 text-white font-semibold text-sm gap-2 shadow-sm cursor-pointer"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 h-10 px-4 rounded-xl border border-red-500/40 text-red-700 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-950/40 text-sm font-semibold transition-colors"
              >
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-3xl border border-border/70 bg-gradient-to-br from-card via-card to-red-50/20 dark:to-red-950/20 p-6 sm:p-8 shadow-sm space-y-6">
              <div className="flex items-center gap-3 pb-4 border-b border-border/50">
                <div className="h-12 w-12 rounded-2xl bg-red-600 text-white flex items-center justify-center font-black text-lg shadow-sm">
                  CH
                </div>
                <div>
              ...
              <div className="space-y-3 text-xs text-muted-foreground">
                <div className="flex items-center justify-between py-1.5 border-b border-border/40">
                  ...
                  <span className="font-semibold text-red-600 dark:text-red-400">Maker & Hardware Engineer</span>
                </div>
              ...
              <div className="rounded-2xl border border-red-500/20 bg-red-50/60 dark:bg-red-950/40 p-4 text-xs text-red-950 dark:text-red-200 flex items-start gap-3">
