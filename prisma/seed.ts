...
async function main() {
  ...
  const shopA = await prisma.shop.create({
    data: {
      ...
      bannerUrl: 'https://images.unsplash.com/photo-1581092160562-40aa08e78832?w=1200&q=80',
  ...
  const shopB = await prisma.shop.create({
    data: {
      ...
      bannerUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af434?w=1200&q=80',
  ...
  const shopC = await prisma.shop.create({
    data: {
      ...
      bannerUrl: 'https://images.unsplash.com/photo-1451187580459-4348727d0d4d?w=1200&q=80',
  ...
  const products: ProductInput[] = [
    // === PHYSICAL: Dev boards ===
    {
      ...
      images: [img('photo-1553406830-ef2513450d76'), img('photo-1581092160562-40aa08e78832'), img('photo-1518770660439-4636190af434')],
    ...
    },
    {
      ...
      image: img('photo-1553406830-ef2513450d76'),
      images: [img('photo-1553406830-ef2513450d76'), img('photo-1581092160562-40aa08e78832')],
      category: catDev.id, shop: shopA.id, seller: sellerA.id,
      stock: 380, weight: 9,
      isTrending: true,
    ...
    },
    {
      ...
      image: img('photo-1518770660439-4636190af434'),
      images: [img('photo-1518770660439-4636190af434'), img('photo-1553406830-ef2513450d76')],
      category: catDev.id, shop: shopA.id, seller: sellerA.id,
      stock: 42, weight: 47,
    ...
    },
    {
      ...
      image: img('photo-1581092160562-40aa08e78832'),
      images: [img('photo-1581092160562-40aa08e78832'), img('photo-1553406830-ef2513450d76')],
      category: catDev.id, shop: shopA.id, seller: sellerA.id,
      stock: 120, weight: 8,
      isNew: true,
    ...
    },
    {
      ...
      image: img('photo-1581092160562-40aa08e78832'),
      images: [img('photo-1581092160562-40aa08e78832')],
      category: catDev.id, shop: shopA.id, seller: sellerA.id,
      stock: 95, weight: 14,
      isTrending: true,
    ...
    // === PCB boards ===
    {
      ...
      image: img('photo-1581092160562-40aa08e78832'),
      images: [img('photo-1581092160562-40aa08e78832'), img('photo-1518770660439-4636190af434')],
    ...
    // === Components ===
    {
      ...
      image: img('photo-1518770660439-4636190af434'),
      images: [img('photo-1518770660439-4636190af434')],
    ...
    // === DIGITAL: KiCad ===
    {
      ...
      image: img('photo-1518770660439-4636190af434'),
      images: [img('photo-1518770660439-4636190af434'), img('photo-1581092160562-40aa08e78832'), img('photo-1553406830-ef2513450d76')],
    ...
    // === DIGITAL: Firmware ===
    {
      ...
      image: img('photo-1553406830-ef2513450d76'),
      images: [img('photo-1553406830-ef2513450d76'), img('photo-1518770660439-4636190af434')],
    ...
    // === SERVICES ===
    {
      ...
      image: img('photo-1451187580459-4348727d0d4d'),
      images: [img('photo-1451187580459-4348727d0d4d'), img('photo-1518770660439-4636190af434')],
    ...
    },
    {
      ...
      image: img('photo-1451187580459-4348727d0d4d'),
      images: [img('photo-1451187580459-4348727d0d4d'), img('photo-1581092160562-40aa08e78832')],
      category: catService.id, shop: shopC.id, seller: sellerC.id,
      unlimited: true,
      isFeatured: true,
